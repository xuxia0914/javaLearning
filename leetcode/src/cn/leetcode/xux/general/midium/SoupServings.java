...
public class SoupServings {
    ...
    public static void main(String[] args) {
        System.out.println(new SoupServings().soupServings(50));    //0.625
        System.out.println(new SoupServings().soupServings(100));    //0.71875
    }
        ...
        for(int i=0;i<=N;i++) {
            for(int j=0;j<=N;j++) {
                if(i==0&&j==0) {
                    ...
                    dp[i][j] = (dp[Math.max(0, i-4)][Math.max(0, j)]
