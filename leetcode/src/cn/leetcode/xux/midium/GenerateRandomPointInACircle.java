...
public class GenerateRandomPointInACircle {
    ...
    public double[] randPoint() {
        double len = Math.sqrt(this.r*this.r*Math.random());
        double tangle = 2*Math.PI*Math.random();
        return new double[]{this.centerX+len*Math.sin(tangle), this.centerY+len*Math.cos(tangle)};
    }
