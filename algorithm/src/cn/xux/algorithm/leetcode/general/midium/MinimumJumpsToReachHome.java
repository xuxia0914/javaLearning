...
public class MinimumJumpsToReachHome {
    ...
    public static void main(String[] args) {
         ...
         * 7 ans = 2
         */
        System.out.println(new MinimumJumpsToReachHome().minimumJumps(
    ...
    public int minimumJumps(int[] forbidden, int a, int b, int x) {
        ...
        while(!queue.isEmpty()) {
            ...
            if(forbidSet.add(curr[1]+a)) {
                if(curr[1]+a==x) {
                    return curr[0]+1;
                }
                queue.offer(new int[]{curr[0]+1, curr[1]+a});
            }
            if(curr[1]>b&&!forbidSet.contains(curr[1]-b)&&forbidSet.add(curr[1]-b+a)) {
                if(curr[1]-b==x) {
                    return curr[0]+1;
                }
                if(curr[1]-b+a==x) {
                ...
                queue.offer(new int[]{curr[0]+2, curr[1]-b+a});
            }
        }
        return -1;
    }
