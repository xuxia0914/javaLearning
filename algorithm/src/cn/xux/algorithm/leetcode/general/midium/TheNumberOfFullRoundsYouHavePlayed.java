...
public class TheNumberOfFullRoundsYouHavePlayed {
    ...
    public int numberOfRounds(String startTime, String finishTime) {
        ...
        int fm = Integer.parseInt(finish[0])*60+Integer.parseInt(finish[1]);
        if(sm>fm) {
            fm += 1440;
        }
        fm = fm/15*15;
        return Math.max(0, (fm-sm)/15);
    }
