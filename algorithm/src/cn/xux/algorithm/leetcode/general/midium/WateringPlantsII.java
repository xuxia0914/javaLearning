 ...
 * 解释：
 * - 只有一株植物
 * - Alice 的水罐有 10 单元水，Bob 的水罐有 8 单元水。
 * 因此 Alice 的水罐中水更多，她会给这株植物浇水。
 ...
 * - Alice 有足够的水给植物 1 ，所以她直接浇水。
 * Bob 的水不够给植物 3 ，所以他先重新装满水，再浇水。
 * - Alice 和 Bob 现在分别剩下 3 单元和 1 单元水。
 * - 由于 Alice 的水更多，所以由她给植物 2 浇水。
 * 然而，她水罐里的水不够给植物 2 ，所以她先重新装满水，再浇水。
 ...
 * 输出：1
 * 解释：
 * Alice 和 Bob 都会到达中间的植物，并且此时他俩剩下的水量相同，
 * 所以 Alice 会给这株植物浇水。
 * 由于她到达时只剩下 1 单元水，所以需要重新灌满水罐。
 * 这是唯一一次需要重新灌满水罐的情况。
 * 所以，两人浇灌所有植物过程中重新灌满水罐的次数 = 1 。
 * <p>
 * <p>
 * 提示：
 * <p>
...
public class WateringPlantsII {
    ...
    public int minimumRefill(int[] plants, int capacityA, int capacityB) {
        ...
        if ((n & 1) == 1 && Math.max(a, b) < plants[n >> 1]) {
            ans++;
        }
        return ans;
    }
