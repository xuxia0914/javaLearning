...
public class SuperPow {
    ...
    public int helper(int a, int[] b) {
        ...
        long res = 1;
        for(int i=0;i<b.length;i++) {
            res = power(res, 10)*power((long)a, b[i])%1337;
        }
        return (int)res;
    }

    public long power(long l, int n) {
        if(l==0l) {
            return 0l;
        }
        if(n==0) {
        ...
        long half = power(l, n/2);
        if(n%2==0) {
            return half*half%1337;
        }else {
            return half*half*l%1337;
        }
    }
    ...
    public int helper1(int a, int[] b) {
        ...
        int carry = divide(b);
        int half = helper1(a, b);
        if(carry==0) {
            return half*half%1337;
        }else {
            return half*half*a%1337;
        }
    }
