...
public class GridGame {
    ...
    public long gridGame(int[][] grid) {
        ...
        for(int i=1;i<n;i++) {
            ...
            preSum[0][n-1-i] = preSum[0][n-i]+grid[0][n-i];
        }
        long ans = preSum[0][0];
        for(int i=1;i<n;i++) {
            ans = Math.min(ans, Math.max(preSum[0][i], preSum[1][i]));
        }
        return ans;
    }
